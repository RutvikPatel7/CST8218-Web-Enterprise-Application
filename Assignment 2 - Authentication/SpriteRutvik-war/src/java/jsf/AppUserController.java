...
import cst8218.pate0635.entity.AppUser;
import cst8218.pate0635.entity.AppUserFacade;
...
public class AppUserController implements Serializable {
    ...
    @EJB
    private cst8218.pate0635.entity.AppUserFacade ejbFacade;
    ...
    public static class AppUserControllerConverter implements Converter {
        ...
        String getKey(String value) {
            ...
            //    com.mycompany.appuser.resources.AppUser 
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof AppUser) {
                ...
                return getStringKey(o.toString());
            } else {
